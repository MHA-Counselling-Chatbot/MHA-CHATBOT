...
class ActionResponseInfo(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        t=test_case
        t.lower()
        if (test_case.startswith("Armita:")|test_case.startswith("Priyanshu:")|test_case.startswith("Saroj:")|test_case.startswith("Anubhav:")|test_case.startswith("Abid:")|test_case.startswith("Rishikant:")):
        ...
        if l>=4:
            ...
            user6=list1[l-2]
            bot7=list1[l-1]
            #x1="[soc][user]"+user0+"[bot]"+bot1+"[user]"+user2+"[bot]"+bot3+"[user]"+user4+"[bot]"+bot5+"[user]"+user6+"[bot]"+bot7+test_case1
            x1="[soc][user]"+user4+"[bot]"+bot5+"[user]"+user6+"[bot]"+bot7+test_case1
        ...
        # when takeing all the context history as a context
        # if l>=2:


        #     #global input1= global input1+" "+test_case1
        #     x1= input1
        #     x1= x1+" "+test_case1
        #     input1 = x1
        #     data={'text': x1}
        # else:
        #     input1="[soc]"+test_case1  
        #     data={'text': input1}  

        #using only two utterance as a context
        # if l>=2:
        ...
        if a in x or b in x or c in x or e in x:
        ...
        ###logic for removing Dr. and Adv. numbers and name
            ...
            changed_x="Kindly visit ""http://www.ncw.nic.in/helplines"" for any legal aid or mental counselling aid."

        elif re.search(regex4,x) or re.search(regex5,x):
            changed_x="Please contact +91-11-26944880 or +91-11-26944883 for filing a complaint. For more information and helpline numbers kindly visit ""http://www.ncw.nic.in/helplines" "."    

        elif re.search(regex6,x):
            changed_x="Please visit ""https://cybercrime.gov.in/webform/Crime_NodalGrivanceList.aspx"" for state wise contact numbers and email addresses or Kindly visit" "http://www.ncw.nic.in/helplines" " for any lega help or mental counselling help. You can also reach out the National Police Helpline at 112, the National Women's Helpline at 181, and the Cybercrime Helpline at 1980 for any help. "     
        ...
        generated_response= "[bot]"+result['text']

        input1=input1+" "+generated_response
...
class ActionDefaultFallback(Action):
    ...
    async def run(
        ...
        ## when taking all history as a context
        # if l>=2:


        #     input1= input1+" "+test_case1
        #     data={'text': input1}
        # else:
        #     input1="[soc]"+test_case1  
        #     data={'text': input1} 
        ...
        ## using two utterances as a context
        # if l>=2:
